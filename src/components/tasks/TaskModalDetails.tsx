                                        ...
                                        <p className="text-lg text-slate-500 mb-2">{data.description} </p>
                                        {
                                            data.completedBy.length ? (
                                                <>
                                                    ...
                                                    <p className="font-bold text-2xl text-slate-600 my-5 mb-2">Historial de cambios</p>
                                                    ...
                                                    {/* <ul className="list-decimal">
                                            {
                                                data.completedBy.map(activityLog => (
                                                    ...
                                                    <ul className="relative border-l-2 ml-1.5 border-slate-300">
                                                        {data.completedBy.map((activityLog, index) => (
                                                            <li key={activityLog._id} className="mb-3 ml-6">
